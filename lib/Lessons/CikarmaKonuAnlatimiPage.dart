...
class cikarmaPage extends StatelessWidget {
  Future<String> loadAsset() async {
    return await rootBundle.loadString('assets/cikarma_text.txt');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: AppColors.backgroundColor,
        title: Text('CIKARMA İŞLEMİ',style: TextStyle(color: AppColors.textColor,),),
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
